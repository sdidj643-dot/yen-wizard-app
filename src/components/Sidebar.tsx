...
import { Store, Plus, Settings, Package, ShoppingCart, Trash2, Edit2, Check, X } from 'lucide-react';
    ...
    <aside className="w-64 bg-sidebar text-sidebar-foreground flex flex-col h-screen">
      ...
      <div className="p-4 border-t border-sidebar-border space-y-1">
        ...
        >
          ...
          <span className="font-medium">庫存管理</span>
        </button>
        <button
        ...
        >
          ...
          <span className="font-medium">訂單管理</span>
        </button>
        <button
